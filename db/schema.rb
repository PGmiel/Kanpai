...
ActiveRecord::Schema.define(version: 2021_06_08_093217) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "first_name"
    t.string "last_name"
    t.string "status_owner" #t.boolean "status-owner", default => false linked to devise/registration/check box
